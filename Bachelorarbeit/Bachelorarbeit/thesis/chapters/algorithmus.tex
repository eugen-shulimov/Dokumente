...
\begin{tikzpicture}
	...
	\node[draw,rectangle split,rectangle split parts=2,align=left] (B) at (5.5,0) {
		...
		\end{tikzpicture}
		\nodepart{two} \textbf{Ausgabe :}\\ Anweisung (a1)};
	...
	\node[draw,rectangle split,rectangle split parts=2,align=left] (C) at (11,0) {
		...
		\end{tikzpicture}
		\nodepart{two} \textbf{Ausgabe :}\\ Anweisung (a1) \\ \textbf{\#if} Bedingung1 (b1)};


	\node[draw,rectangle split,rectangle split parts=2,align=left] (D) at (0,-10) {
		\begin{tikzpicture}
			\node[draw,diamond,fill=lightgray,thick] {root}
			child {node[draw,circle,thick] {a1}}
			child {node[draw,rectangle,thick] {\textbf{if} b1}
			...
			\draw [>=stealth,red,->,line width=1mm] (-0.5,-2) -- (-0.7,-2.5);
			\node[rectangle split, rectangle split parts=4,draw, anchor=center] at (2.5,0) {\nodepart{two} a2 \nodepart{three} \textbf{else} \nodepart{four}a4};
		\end{tikzpicture}
		\nodepart{two} \textbf{Ausgabe :}\\ Anweisung (a1) \\ \textbf{\#if} Bedingung1 (b1) \\ \hspace*{5mm}\textbf{\#if} Bedingung2 (b2)};
		
		
	\node[draw,rectangle split,rectangle split parts=2,align=left] (E) at (5.5,-10) {
		\begin{tikzpicture}
			\node[draw,diamond,fill=lightgray,thick] {root}
			child {node[draw,circle,thick] {a1}}
			child {node[draw,rectangle,thick] {\textbf{if} b1}
			...
			\draw [>=stealth,red,->,line width=1mm] (-0.3,-3.4) -- (-0.5,-4);
			\node[rectangle split, rectangle split parts=4,draw, anchor=center] at (2.5,0) {\nodepart{two} a2 \nodepart{three} \textbf{else} \nodepart{four}a4};
		\end{tikzpicture}
		\nodepart{two} \textbf{Ausgabe :}\\ Anweisung (a1) \\ \textbf{\#if} Bedingung1 (b1) \\ \hspace*{5mm}\textbf{\#if} Bedingung2 (b2) \\ \hspace*{5mm}Anweisung2 (a2)};	
			
			
	\node[draw,rectangle split,rectangle split parts=2,align=left] (F) at (11,-10) {
		\begin{tikzpicture}
			\node[draw,diamond,fill=lightgray,thick] {root}
			child {node[draw,circle,thick] {a1}}
			child {node[draw,rectangle,thick] {\textbf{if} b1}
